...
export const board = <i className="fa-solid fa-bars"></i>;
...
export const teams = <i className="fa-solid fa-user-plus" style={{ color: "#FFFFF" }}></i>;
export const join = <i className="fa-solid fa-user-plus"></i>;
export const analytics = <i class="fa-solid fa-chart-line" style={{ color: "#FFFFF" }}></i>;
